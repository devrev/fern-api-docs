...
An _extractor_ is a function in an ADaaS-capable snap-in responsible for extracting data from an external system, such as Jira, Zendesk,
...
A _reverse sync_ is a sync run from DevRev to an external system. It uses a loader function, to create and/or update data
