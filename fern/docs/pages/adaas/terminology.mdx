...
For GitHub, this would be the organization name, for example `devrev` in `github.com/devrev`.
For Jira, this would be the organization name in the Jira domain name, for example `devrev` in `devrev.atlassian.net`.
