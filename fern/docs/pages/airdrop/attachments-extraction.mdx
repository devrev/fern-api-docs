...
If you need to customize the attachments extraction:

1. Modify the implementation in `attachments-extraction.ts`
2. Use the `streamAttachments` function from the WorkerAdapter class
