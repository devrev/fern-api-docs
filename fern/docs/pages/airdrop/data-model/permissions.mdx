...
To define the `targets` field in the external domain metadata, specify a list of strings representing the record types or record type categories the policy applies to.
