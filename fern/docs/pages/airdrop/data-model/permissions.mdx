...
The `shared_with` field allows you to specify who can access an article and what level of permissions they have.
This field uses the `permission` type to connect users or groups with specific roles.
