...
| `ref_type`             | String | Yes      | Record type of the mentioned item (for example, "issue", "comment") as defined in the external domain metadata. Will be converted to the DevRev leaf type based on user mappings.   |
