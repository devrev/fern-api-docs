...
Article permissions are managed through the `shared_with` field, which can reference users, groups, and platform groups. Refer to the [permissions section](permissions.mdx) for more details.
