...
Mentions to artifacts and articles are supported. An inline attachment must be mapped to an artifact. A link to another article must be mapped to an article.
