...
Rich text is used in DevRev to represent text fields that can be formatted and can contain mentions. 
E.g.: description of an issue, body of a conversation, etc.
