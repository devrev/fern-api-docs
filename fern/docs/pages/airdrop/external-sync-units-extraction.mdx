...
The snap-in should emit the list of external sync units in the provided event message
...
Start a new airdrop in the DevRev App.

If external sync units extraction is successful, you should be prompted to choose an external sync unit from the list.
