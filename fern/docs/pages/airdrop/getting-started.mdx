...
- **API documentation**: Obtain the official API documentation of the external system.
  This will be the primary source of information about how to connect and interact with the system.
...
- **Error handling**: Learn about error response formats and codes. Knowing this will help in
  effectively handling errors and exceptions in your integration.
