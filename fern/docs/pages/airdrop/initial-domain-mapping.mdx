...
```
This enables mapping in both directions.

If your org is not in US-East-1, you have to override an environment variable to make sure the tool reaches the right server, e.g.:
