...
<AccordionGroup>
  ...
  <Accordion title="Working with integer fields">
    ...
    These are, however, not *conceptually integers* in AirSync's perspective.
  ...
  <Accordion title="Using struct fields">
    ...
    Such detailed references should not be declared as structs in AirSync. 
