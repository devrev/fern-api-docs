...
<Tip>
To assist you in creating the AirSync snap-in you can add DevRev's documentation to your MCP server, just add `https://developer.devrev.ai/public/airdrop/` as a custom docs URL.
...
```markdown
When asked to perform AirSync initial mapping:
