---
title: Supported DevRev object types
---
...
| Object Type | Object Hierarchy | Loading | Extraction | Subtype | Comment |
|-------|-------------|:-------:|:----------:|:-------:|-------------|
| [new_custom_object](#new_custom_object) | custom_object | ✔︎ | ✔︎ | ✔︎ | _Example of how custom objects look in the context of AirSync mapping_ |
| [account](#account) | account | ✔︎ |  |  |  |  |
| [airdrop_authorization_policy](#airdrop_authorization_policy) | airdrop_authorization_policy | ✔︎ |  |  | _The intermediate object type for creating MFZ object types_ |
| [airdrop_platform_group](#airdrop_platform_group) | airdrop_platform_group | ✔︎ |  |  | _The representation of the default DevRev groups_ |
...
|-------|-------------|
| Can Load | Indicates that the object type can be loaded into the DevRev with AirSync. |
