...
|-------|-------------|:-------:|:----------:|:-------:|:----------:|-------------|
| [new_custom_object](#new_custom_object) | custom_object | ✔︎ | ✔︎ | ✔︎ |  | _New custom object is an example of how custom objects look in the context of AirSync mapping._ |
