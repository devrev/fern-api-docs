In this tutorial, you'll learn how to create an account and contacts associated with it in DevRev with the `accounts-create` API. You can also [create accounts manually in the DevRev app](https://docs.devrev.ai/product/customers#add-new-customers).
