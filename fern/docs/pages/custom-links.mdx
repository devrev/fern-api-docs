...
To add more valid source subtypes, use the update endpoint to add them to the `source_types_v2` array.
</Callout>
...
<Callout intent="info">
This section lists common links you can create from tickets and issues. It is not an exhaustive list.
</Callout>
...
src -- "&nbsp; is dependent on &nbsp;" --> iss
src -- "&nbsp; is related to &nbsp;" --> art
src -- "&nbsp; is related to &nbsp;" --> t1
src -- "&nbsp; is parent of &nbsp;" --> t1
src -- "&nbsp; is merged into &nbsp;" --> t1
```

<Callout intent="note">
Only ticket → issue is allowed for creating a link with "is dependent on". Creating the link in reverse (issue → ticket) is not possible; however, you can swap the source and target objects to achieve the same result.
</Callout>
...
src -- "&nbsp; is parent of &nbsp;" --> t1
src -- "&nbsp; is parent of &nbsp;" --> task
src -- "&nbsp; is dependent on &nbsp;" --> t1
src -- "&nbsp; is related to &nbsp;" --> t1
src -- "&nbsp; is duplicate of &nbsp;" --> t1
```
...
| is duplicate of | Not specified | Not specified | Not specified | Not specified | For example, issue → issue; no extra constraints configured |
