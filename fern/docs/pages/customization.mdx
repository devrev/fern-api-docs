...
--header 'Authorization: <TOKEN>' \
--data '{
    "id": "don:core:dvrv-us-1:devo/11FVC3ScK:issue/2"
}'
...
<Callout>
Let's say that the developers in your organization tend to forget to add a RCA when
resolving the bugs. You can make the _RCA_ field required when a _bug_ object
