...
This guide provides an overview of the customization framework and walks you through the
process of tracking bugs in your organization. By the end of this guide, you'll be able
to:
...
<Callout intent="tip">
When you see `leaf_type` in the documentation or API, it simply refers to the type of
DevRev object you're working with (like _issue_ or _ticket_).
</Callout>
