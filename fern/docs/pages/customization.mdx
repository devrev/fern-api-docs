...
This guide provides an overview of the customization framework and walks you through the process of tracking incidents in your organization. By the end of this guide, you'll be able to:
...
To view the custom schema fragments, use the following API call:
...
<Callout intent="success">
Let's say you want to do the following modifications to the priority field in your org:
...
Any attempt to update an _incident_ object to the _completed_ stage without populating
the _PIA_ field is rejected.
...
<Callout intent="info">
`don:core:dvrv-us-1:devo/11FVC3ScK:stage/5` is the ID of the _completed_ stage. The
