...
Once you have [installed PLuG](./web-sdk-install), all your users who interact with the widget are created as anonymous users in the DevRev app with a random name since there is no information about the user.
