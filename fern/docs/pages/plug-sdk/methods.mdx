...
|session_recording_options   |Options for recording observability sessions.   |To view the values, see [Session recording](#session-recording) |No   |
...
### Start session recording <a id="session-recording"></a>
