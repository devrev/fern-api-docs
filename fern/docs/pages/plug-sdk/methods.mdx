...
| `session_recording_options`  | Options for recording observability sessions.                                                                                                                                         | To view the values, see [Session recording options](https://devrev.ai/docs/plug/observability-getting-started) |
