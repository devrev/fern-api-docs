...
|enable_default_launcher   |Show/hide the default PLuG widget launcher.   |Boolean (True or False)   |No   |
...
|session_recording_options   |Options for recording observability sessions.   |To view the values, see [Session recording options](https://devrev.ai/docs/plug/observability-getting-started) |No   |
