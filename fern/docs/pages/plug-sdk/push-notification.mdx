...
a. After selecting **iOS App**, fill out the configuration form:
  ...
  - **Bundle ID**: Provide your app's unique identifier in reverse domain notation, for example, `com.example.app`. Refer to [Apple's documentation](https://developer.apple.com/documentation/appstoreconnectapi/bundle_ids) to confirm your bundle ID.
