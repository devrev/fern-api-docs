...
- **Mobile SDK integration**: Ensure that the DevRev SDK is integrated with your app and tested to facilitate notifications.
    - [Integrate PLuG SDKs with your Android app](./sdk-android)
    - [Integrate PLuG SDKs with your iOS app](./sdk-ios)
