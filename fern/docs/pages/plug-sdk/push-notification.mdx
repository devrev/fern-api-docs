...
- **Mobile SDK integration**: Ensure that the DevRev SDK is integrated with your [Android](./sdk-android) or [iOS](./sdk-ios) app and tested to facilitate notifications.
