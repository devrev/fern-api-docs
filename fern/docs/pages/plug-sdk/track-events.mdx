...
**Viewing user events**: Navigate to the user profile and click on the **Usage** tab. This data is refreshed every 24 hours. Events can also be viewed directly within user sessions, where the data is updated instantaneously.
