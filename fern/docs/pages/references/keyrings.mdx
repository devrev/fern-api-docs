...
This document defines keyrings, a DevRev-specific mechanism for managing authentication with external services. Keyrings are called connections in the DevRev app.
