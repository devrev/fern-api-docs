...
These are user-defined keyring types that can be used to establish secure connections with external services. Custom keyring types are defined in the snap-in manifest under the `keyring_types` section.

    Create a developer keyring using the CLI
    ```bash
    echo $CLIENT_CREDENTIALS | devrev keyring create `oauth-secret` <name of the keyring>
    ```
    Create a developer keyring using the manifest
    ```yaml
    developer_keyrings:
        ...
        keyrings:
            ...
            user:
              - name: example connection
                ...
                display_name: Organization secret token
    ```
    2.1 **Customize predefined keyring type**:
              ...
              - id: custom-example-connection
                ...
                scopes:
                  ...
                  - name: write
                    ...
                    is_optional: true
    ```
    2.2 **Custom keyring type definition**:
