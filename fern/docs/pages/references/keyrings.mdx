...
For more clientInformation, refer to [Keyrings](/snapin-development/references/manifest#keyrings) in snap-in manifest. They can be categorized into two main types:
