    ...
    keyrings:
        ...
        user:
          -  name: my-secret-user-token
             ...
             display_name: Your secret token
    ```
3. **Custom keyring types**: These are user-defined keyring types that can be used to establish secure connections with external services. Custom keyring types are defined in the snap-in manifest under the `keyring_types` section.

    1. Keyring usage in manifest
        ```yaml
            keyrings:
                organization:
                ...
                user:
                  - name: example connection
                    ...
                    display_name: Organization secret token
        ```
    2. Define OAuth keyring type
           Here's an example of a custom keyring type for establishing secure OAuth connections within your DevRev snap-in:
        2.1 Creating a developer keyring
             - 1.1 **CLI command**:
                  ```bash
             ...
             - 1.2 **Manifest declaration**:
                  ...
                  developer_keyrings:
                    - name: custom-oauth-credentials
                      ...
                      display_name: Developer secret token
               ```
        2.2.1 **Customize predefined keyring type**:
        ...
        ```yaml
            keyring_types:
              - id: custom-example-connection
                ...
                kind: OAuth2
                oauth_secret: custom-oauth-credentials
                ...
                scopes:
                  ...
                  - name: write
                    ...
                    is_optional: true
         ```
        2.2.2 **Custom keyring type definition**:
            This document details the complete configuration of a custom keyring type for establishing secure OAuth connections within your snap-in.
        ```yaml
            keyring_types:
              - id: custom-example-connection // Unique identifier for your custom type, used in the `keyring` section of the manifest.
                ...
                oauth_secret: custom-oauth-credentials  // Developer keyring reference
                authorize:
                    type: "config"
    ...
    ```
    4. Define Multi-filed keyring type
