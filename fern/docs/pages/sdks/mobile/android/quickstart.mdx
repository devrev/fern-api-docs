...
## Sample app
A sample app demonstrating use cases with both XML-based UI and Jetpack Compose has been provided as part of our [public repository](https://github.com/devrev/devrev-sdk-android/).
