...
## Sample app
A sample app with use cases for the DevRev SDK for Cordova has been provided as a part of our [public repository](https://github.com/devrev/devrev-sdk-cordova). To set up and run the sample app, follow these steps:
