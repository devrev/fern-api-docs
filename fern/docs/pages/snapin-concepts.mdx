...
In case the developers want to make their snap-ins available to only their dev org and/or some external ones, they can publish them to marketplace with `restricted` access.
